...
# Passiamo il tempo di inizio e
# il numero di richieste fino a quel momento
def rate_minute():
    # Tempo di inizio
    ...
    if elapsed_time > 60 and request_count < 900:
        ...
        # Stampa un messaggio che avverte che il limite di richieste
        # API è stato superato e indica il tempo rimanente prima del reset.
        print("Superato il limite di richieste API. Attendi 60 secondi prima di continuare.")
